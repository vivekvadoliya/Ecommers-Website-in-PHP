...
<div class="contactus">
   ...
   <div class="contact">
         <div class="container-fluid padddd">
            ...
            <div class="row">
               <div class="center">
                <form class="main_form" action="php/contact data.php" method="POST">
                   <div class="row">
                      <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12">
                         <input class="form-control" name="name" id="" placeholder="Name" type="text" name="Name" required>
                         <span class="error_form" id="name_error_message"></span>
                      </div>
                       <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12">
                         <input class="form-control" name="email" id="" placeholder="Email" type="email" name="Email" required>
                         <span class="error_form" id="email_error_message"></span>
                      </div>
                       <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12">
                         <input class="form-control" name="phone" id="" placeholder="Phone" type="text" name="Phone" required>
                         <span class="error_form" id="number_error_message"></span>
                      </div>
                       <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12">
                         <textarea class="textarea" name="message" id="" placeholder="Message" type="text" name="Message"></textarea>
                      </div>
                       <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12">
...
<script type="text/javascript">
		...
		function check_name() {
			...
			$("#name_error_message").html("should contain only integer");
		...
		$("#registration_form").submit(function() {
			...
			if (error_number === false && error_name === false && error_email === false) 
