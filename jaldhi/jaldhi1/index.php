            ...
            <div class="row g-0">
                ...
                <div class="font col-lg-7 text-center py-5">
                    <div class="offset-1 col-lg-10 pt-5">
                        ...
                        <h4 style="color: #6c757d;">Let's Sign Up here</h4>
                        <br>
                    </div>
                    ...
                    <div class="row-g-2">
                        <form action="" method="post">
                            ...
                            <div class="offset-1 col-lg-10 pt-4">
                                <button type="submit" class="btn btn-outline-warning" name="reg">Sign Up</button>
                            </div>
                        </form>
                    </div>
                    ...
                    <div class="offset-1 col-lg-10 pt-5">
                        <h5 class="font2 mb-md-5 mb-4" style="color: #6c757d;word-spacing: 1px;">Already Have Account
                            Then
                            <a href="sign in.php" class="link">Login</a> Here
                        </h5>
